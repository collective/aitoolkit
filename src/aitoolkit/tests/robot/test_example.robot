...
#
#  $ bin/test -s aitoolkit -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src aitoolkit.testing.AITOOLKIT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/aitoolkit/tests/robot/test_example.robot
#
